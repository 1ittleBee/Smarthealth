...
function DoctorPermission() {
  ...
  return (
    <div className="backgroundImage bg-gradient-to-b from-purple-500 to-purple-800 min-h-screen flex flex-col justify-center items-center p-4 font-mono text-yellow-300">
